      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-white/[0.08]">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {(footer.storeLinks.showGooglePlay || footer.storeLinks.showAppStore) && (
              <div className="pt-2 space-y-3">
                <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Download App</p>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {footer.storeLinks.showGooglePlay && (
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p className="text-[9px] text-[#A1A1AA] uppercase font-bold tracking-wider leading-none">Get it on</p>
                  ...
                  {footer.storeLinks.showAppStore && (
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p className="text-[9px] text-[#A1A1AA] uppercase font-bold tracking-wider leading-none">Download on the</p>
          ...
          <div className="lg:col-span-2 space-y-5">
            <h4 className="font-bold text-sm uppercase tracking-wider text-white">Admission Programs</h4>
          ...
          <div className="lg:col-span-2 space-y-5">
            <h4 className="font-bold text-sm uppercase tracking-wider text-white">Platform</h4>
            <ul className="space-y-3 text-sm font-medium">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="font-bold text-sm uppercase tracking-wider text-white">{footer.newsletterHeading}</h4>
