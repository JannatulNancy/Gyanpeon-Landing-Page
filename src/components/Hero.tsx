      ...
      <div className="max-w-[1320px] w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            {/* Small Badge */}
            <motion.div 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-[#6C4CF5] text-xs font-bold uppercase tracking-wider mb-6 shadow-sm"
            ...
            {/* Main Headline */}
            <h1 className="font-serif font-bold text-[44px] sm:text-[54px] xl:text-[64px] leading-[1.1] text-[#111111] tracking-tight">
              {heroHeadline.split('\n')[0]} <br />
              {heroHeadline.split('\n')[1] || ''}
            </h1>
            ...
            <div className="mt-4 relative inline-block">
              <span className="font-serif font-semibold text-[34px] sm:text-[44px] xl:text-[50px] bg-gradient-to-r from-[#6C4CF5] via-[#8B5CF6] to-[#F59E0B] bg-clip-text text-transparent">
                {heroGradientText}
              </span>
              {/* Orange Underline SVG Stroke */}
              <svg 
                className="absolute -bottom-2.5 left-0 w-full h-4 text-[#F59E0B]" 
                viewBox="0 0 240 16" 
                fill="none" 
            ...
            {/* Slogan Line */}
            <h2 className="mt-8 font-semibold text-[#6C4CF5] text-[20px] sm:text-[22px] tracking-normal">
              {heroSlogan}
            </h2>

            {/* Description */}
            <p className="mt-4 text-[#555] text-[16px] sm:text-[17px] leading-[1.65] max-w-[500px]">
              {heroDescription}
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 w-full sm:w-auto">
              <motion.a
                href="#get-started"
                className="h-[54px] px-8 rounded-2xl bg-[#6C4CF5] text-white font-bold text-base flex items-center justify-center gap-2 shadow-lg shadow-[#6C4CF5]/20 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
              ...
              <motion.a
                href="#courses"
                className="h-[54px] px-8 rounded-2xl bg-white text-[#111111] border border-slate-200 font-bold text-base flex items-center justify-center gap-2 shadow-sm hover:bg-[#FAF8FF] hover:border-purple-200 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
            ...
            <div className="mt-10 pt-6 border-t border-slate-100 flex items-center gap-5 text-xs text-gray-500 font-semibold uppercase tracking-wider">
