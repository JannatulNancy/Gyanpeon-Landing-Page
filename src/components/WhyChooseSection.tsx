              ...
              <div className="relative bg-white rounded-[32px] p-6 sm:p-8 shadow-2xl border border-purple-100/60 space-y-6">
                ...
                <div className="flex items-center justify-between pb-6 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-950 text-[16px]">Daily Exam Battle</h4>
                      <p className="text-[11px] text-slate-400 font-semibold">Nationwide Admission League</p>
                    </div>
                  </div>
                ...
                <div className="bg-[#FAF8FF] p-5 rounded-2xl border border-purple-100/50 space-y-3">
                  <div className="flex justify-between items-center text-xs font-bold text-slate-700">
                    ...
                    <span className="text-[#6C4CF5]">+24% This Month</span>
                  </div>
                ...
                <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-5 rounded-2xl shadow-xl flex items-start gap-4 relative overflow-hidden">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-xs text-slate-200 leading-relaxed">
                      "Here is the high-yield shortcut formula for Medical Botany cells. Let's practice 3 past year solutions!"
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div className="p-3 rounded-xl border border-slate-100 flex items-center gap-3 bg-white">
                    ...
                    <div>
                      <p className="text-[10px] text-slate-400 font-semibold uppercase">Resources</p>
                      <p className="text-sm font-extrabold text-slate-800">25,000+ Notes</p>
                    </div>
                  </div>
                  <div className="p-3 rounded-xl border border-slate-100 flex items-center gap-3 bg-white">
                    <Trophy className="w-5 h-5 text-[#F59E0B]" />
                    <div>
                      <p className="text-[10px] text-slate-400 font-semibold uppercase">Model Tests</p>
                      <p className="text-sm font-extrabold text-slate-800">NCTB & Board</p>
                    </div>
                  </div>
                </div>
